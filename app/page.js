...
export default function Teachy() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Slight delay for natural typing
  ...
  return (
    <div className="teachy-container">
      ...
      <style jsx>{`
        ...
        .mobile-topbar { display: none; padding: 12px; align-items: center; gap: 10px; }
        ...
        .chat-input input { flex: 1; padding: 14px 20px; border-radius: 25px; border: none; outline: none; font-size: 0.95rem; }
        ...
        @media (max-width: 768px) {
          ...
          .chat-area { flex: 1; padding-bottom: 70px; }
